  ...
  return (
    ...
    >
      <div className="grid gap-4 py-4">
        <CompanyInfoFields jobData={jobData} handleChange={handleChange} />
        ...
        <AdditionalInfoFields jobData={jobData} handleChange={handleChange} />

        <JobDescriptionField jobData={jobData} handleChange={handleChange} />
      </div>
